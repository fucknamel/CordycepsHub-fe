 ...
 * @Last Modified time: 2019-04-03 17:08:13
 */
...
var config = {
  ...
  output: {
    path: __dirname + "/dist/",
    publicPath: 'dev' === WEBPACK_ENV ? '/dist/' : '//s.cordycepshub.com/CordycepsHub-fe/dist/',
    filename: "js/[name].js"
  },
  externals: {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(getHtmlConfig('product-list', '虫草列表')),
